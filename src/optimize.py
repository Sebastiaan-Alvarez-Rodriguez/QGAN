...
def optimize(callable: callable, paramlist, strategy: TrainingType, max_iter, step_rate):
    if strategy == TrainingType.ADAM:
        ...
        res = minimize(callable, paramlist, method=methodname, tol=10**-4, options={'maxiter':max_iter})
