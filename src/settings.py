...
class DiscriminatorSettings(object):
    def __init__(self, num_qubits, num_layers, n_shots, max_iter=80):
        self.num_qubits = num_qubits
...
step_rate = 0.1
global g_settings
g_settings = GeneratorSettings(g_num_qubits, depth, g_n_shots, paramtype, trainingtype, g_max_iter, step_rate)
...
d_max_iter = 80
global d_settings
d_settings = DiscriminatorSettings(d_num_qubits, num_layers, d_n_shots, d_max_iter)
